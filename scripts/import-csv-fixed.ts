 ...
 * Imports data from CSV files into Neon DB tables with column mapping support
 */
...
class CSVImporter {
  ...
  private async insertRecord(
    ...
    try {
      ...
      // Apply column mappings for schema compatibility
      const mappedRecord = this.applyColumnMappings(tableName, cleanedRecord);
   ...
   */
  private cleanRecord(record: Record<string, string>): Record<string, unknown> {
